...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory(LangUtil.getString('catAppearance'), [
			...
			new WatermarkOption(LangUtil.getString('descWatermark')), new NoteSplashToggle(LangUtil.getString('descNoteSplash')),
			new MillisecondOption(LangUtil.getString('descMillisecond'))]),
		#if FEATURE_CACHING
